...
TEST(LockManagerTest, DISABLE_TwoPLTest) { TwoPLTest(); }
...
TEST(LockManagerTest, DISABLE_UpgradeLockTest) { UpgradeTest(); }
...
TEST(LockManagerTest, DISABLE_WoundWaitBasicTest) { WoundWaitBasicTest(); }
